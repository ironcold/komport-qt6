...
/**
  ...
  * KomportApp reimplements the methods that KMainWindow provides for main window handling and supports
  ...
  */
class KomportApp : public KMainWindow
{
  Q_OBJECT
  ...
  public:
     ...
     */
    KomportApp(QWidget* parent=0, const char* name=0);
    ~KomportApp();
