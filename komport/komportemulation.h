/***************************************************************************
                          komportemulation.h  -  Komport Serial Port Communicator
                             -------------------
...
public slots:
  ...
  /** received and process an incoming character */
  virtual void slotReceivedChar(char _ch);
private:
  /** serial */
